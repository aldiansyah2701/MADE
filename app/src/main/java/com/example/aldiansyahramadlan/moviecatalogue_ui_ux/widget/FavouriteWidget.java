...
public class FavouriteWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.aldiansyahramadlan.moviecatalogue_ui_ux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.aldiansyahramadlan.moviecatalogue_ui_ux.EXTRA_ITEM";
